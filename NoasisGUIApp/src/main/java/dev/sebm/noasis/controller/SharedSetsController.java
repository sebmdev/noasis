...
@Component
public class SharedSetsController implements Initializable {
    ...
    public SharedSetsController(Preferences preferences, ApplicationContext applicationContext, FlashCardsController flashCardsController, FlashCardAddEditController flashCardAddEditController, DashboardLayoutController dashboardLayoutController) {
